        ...
        <section class="content">
            ...
            <div class="box box-primary">
                ...
                <div class="box-header with-border">
                    ...
                    <h3 class="box-title" style="margin-bottom: 15px">{{__('messages.products')}} <small>{{ $products->total() }}</small></h3>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                @if (auth()->user()->hasPermission('create_products'))
                                    <a href="{{ route('dashboard.products.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> {{__('messages.add')}}</a>
                                @else
                    ...
                    @if ($products->count() > 0)
                        ...
                        <table class="table table-hover">
                            ...
                            <tr>
                                ...
                                <th>{{__('messages.profit_percent') }}%</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if (auth()->user()->hasPermission('update_products'))
                                            <a href="{{ route('dashboard.products.edit', $product->id) }}" class="btn btn-info btn-sm"><i class="fa fa-edit"></i> {{__('messages.edit')}}</a>
                                        @else
