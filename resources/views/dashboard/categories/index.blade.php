        ...
        <section class="content">
            ...
            <div class="box box-primary">
                ...
                <div class="box-header with-border">
                    ...
                    <h3 class="box-title" style="margin-bottom: 15px">{{__('messages.categories')}} <small>{{ $categories->total() }}</small></h3>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                @if (auth()->user()->hasPermission('create_categories'))
                                    <a href="{{ route('dashboard.categories.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i>{{ __('messages.add')}}</a>
                                @else
                    ...
                    @if ($categories->count() > 0)
                        ...
                        <table class="table table-hover">
                            ...
                            <tr>
                                ...
                                <th>{{__('messages.related_products')}}</th>
                            ...
                            @foreach ($categories as $index=>$category)
                                <tr>
                                    ...
                                    <td><a href="{{ route('dashboard.products.index', ['category_id' => $category->id]) }}" class="btn btn-info btn-sm">{{__('messages.related_products')}}</a></td>
                                    <td>
                                        @if (auth()->user()->hasPermission('update_categories'))
                                            <a href="{{ route('dashboard.categories.edit', $category->id) }}" class="btn btn-info btn-sm"><i class="fa fa-edit"></i> {{__('messages.edit')}}</a>
                                        @else
